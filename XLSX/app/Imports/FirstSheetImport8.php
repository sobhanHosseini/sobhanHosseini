...
class FirstSheetImport8 implements WithStyles,FromArray, WithHeadings, WithTitle, ShouldAutoSize, WithColumnFormatting, WithMapping
{
    protected $rows;
    ...
    {
        return 'Disشناس آزمايشگاه ميکروبي تصفيه خانه';
    }
